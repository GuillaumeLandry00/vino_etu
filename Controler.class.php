...
class Controler
{
    ...
    private function cellier()
    {
        ...
        include "vues/entete.php";
        //include("vues/addListeAchat.php");
    ...
    //ajout des donnes a la seesion pour crer la liste d achat
    private function addlisteAchat()
    {
        if (!isset($_SESSION)) {
        ...
        //si cette session n existe pas il faut l creer
        ...
        if (isset($_GET['id'])) {
            ...
            $resultat = $liste->getUneBouteilleCellier($_GET['id']);
            if (empty($resultat)) {
                die("cet produit n exite pas");
            }else{
				$_SESSION['listeAchat'][$_GET['id']] = $resultat;
			}
           
            //  $s =$liste->addSession($_GET['id']);
          //  var_dump($_SESSION['listeAchat']);
        } else {
            die("vous n avez pas selecionne un produit");
        }
    }
	...
	unset($_SESSION['listeAchat'][$_GET['id']]);
	$dataListe =$_SESSION['listeAchat'];
	include "vues/entete.php";
		include "vues/listeAchat.php";
		include "vues/pied.php";
